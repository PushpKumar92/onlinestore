                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up">
                            ...
                            <div class="wrapper-info">
                                ...
                                <a href="{{ route('blog.details')}}"class="about-details wrapper-details">It’s official! The
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up">
                            ...
                            <div class="wrapper-info">
                                ...
                                <a href="{{ route('blog.details')}}" class="about-details wrapper-details">Must-Have WordPress
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up">
                            ...
                            <div class="wrapper-info">
                                ...
                                <a href="{{ route('blog.details')}}" class="about-details wrapper-details">Top 10 Best Professional Ecommerce Blogging Platforms for 2022
                                </a>
                                <div class="divider"></div>
                                <a href="#" class="shop-btn">
                                    Learn More
                    ...
                    <div class="col-lg-4 col-sm-6">
                        <div class="blogs-wrapper product-wrapper" data-aos="fade-up">
                            ...
                            <div class="wrapper-info">
                                ...
                                <a href="{{ route('blog.details')}}" class="about-details wrapper-details">Business-to-consumer Ecommerce that involves selling fight products
                                </a>
                                <div class="divider"></div>
