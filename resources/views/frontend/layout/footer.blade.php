                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="footer-order">
                        ...
                        <div class="footer-link order-link">
                            <ul>
                                <li><a href="{{ route('order') }}"> <i class="fa-solid fa-greater-than me-2"
                                            style="font-size:12px; color:white;"></i>Track Order</a></li>
                                <li><a href="{{ route('cart') }}"> <i class="fa-solid fa-greater-than me-2"
                                            style="font-size:12px; color:white;"></i>Delivery & Returns</a></li>
                                <li><a href="{{ route('about') }}"> <i class="fa-solid fa-greater-than me-2"
                                            style="font-size:12px; color:white;"></i>Warranty</a></li>
                            </ul>
