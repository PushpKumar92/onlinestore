...
<section class="product footer">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="about-us">
                        ...
                        <div class="footer-link about-link">
                            <ul>
                                <li><a href="{{ route('about') }}"> <i class="fa-solid fa-greater-than me-2"
                                            style="font-size:12px; color:white;"></i>About Us</a>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="links">
                        ...
                        <div class="footer-link useful-link">
                            <ul>
                                <li><a href="{{ route('about') }}"> <i class="fa-solid fa-greater-than me-2"
                                            style="font-size:12px; color:white;"></i>Secure Payment</a></li>
                                <li><a href="{{ route('privacy') }}"> <i class="fa-solid fa-greater-than me-2"
                    ...
                    <div class="contact-info">
                        ...
                        <div class="footer-link contact-link">
                            <div class="address">
                                <div class="icon">
                                        <span>
                                    <i class="fa-solid fa-location-dot" style="font-size: 22px; color: #fff; border: 1px solid #424242; padding: 10px; border-radius: 50%;"></i>
                                    </span>
                                </div>
                                <div class="details">
                            ...
                            <div class="phone address">
                                <div class="icon">
                                    <span>
                                    <i class="fa-solid fa-phone" style="font-size: 22px; color: #fff; border: 1px solid #424242; padding: 10px; border-radius: 50%;"></i>
                                    </span>
    ...
    <section class="custom-section">
        <div class="container semi-footer">
            ...
            <div class="semi-footer">
                <div class="column text-column social-column">
                    <h4 class="social-heading">Our Social Links:</h4>
                    <div class="social-icons">
                        <a href="#" target="_blank" aria-label="Facebook" class="facebook">
