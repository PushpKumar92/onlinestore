<header id="header" class="header">
    ...
    <img src="{{ asset('assets/images/logos/logo.webp') }}" alt="logo">
                ...
                <div class="header-cart-items">
                    ...
                    <div class="header-compaire">
                        <a href="{{ route('compaire') }}" class="cart-item">
                            <span>
                    ...
                    <div class="header-cart">
                        <a href="{{ route('card') }}"  class="cart-item">
                            <span>
                        ...
                        <div class="cart-submenu">
                            ...
                            <div class="cart-wrapper-section">
                                ...
                                <div class="cart-btn">
                                    <a href="{{ route('card') }}"  class="shop-btn view-btn">View Cart</a>
    ...
    <nav class="mobile-menu d-block d-lg-none">
        <div class="mobile-menu-header d-flex justify-content-between align-items-center">
            ...
            <a href="{{ route('card') }}"class="header-cart cart-item">
                <span>
                        ...
                        <li class="mega-menu">
                            ...
                            <div class="shop-menu">
                                <div class="menu-wrapper">
                                    ...
                                    <ul>
                                            <li><a
                                                    href="{{ route('product.sidebar', ['category' => 'shirt']) }}">hand Bag </a>
                                            </li>
                                            <li><a
                                                    href="{{ route('product.sidebar', ['category' => 'skart']) }}">Mobile Bag</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('product.sidebar', ['category' => 't-shirt']) }}">School Bag</a>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="menu-list">
                                        <h5 class="menu-title">Cosmetics</h5>
                                                                          <ul>
                                            <li><a
                                                    href="{{ route('product.sidebar', ['category' => 'shirt']) }}">Lipstics </a>
                                            </li>
                                            <li><a
                                                    href="{{ route('product.sidebar', ['category' => 'skart']) }}">foundation</a>
                                            </li>
                                            <li><a
                                                    href="{{ route('product.sidebar', ['category' => 't-shirt']) }}">Eye Liner</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
