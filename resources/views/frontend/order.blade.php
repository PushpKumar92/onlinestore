                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="about-us">
                            ...
                            <div class="footer-link about-link">
                                <ul>
                                    <li><a href="{{ route('about')}}">Rave’s Story</a></li>
                                    <li><a href="{{ route('about')}}">Work With Us</a></li>
                                    <li><a href="{{ route('about')}}">Coporate News</a></li>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="links">
                            ...
                            <div class="footer-link useful-link">
                                <ul>
                                    <li><a href="{{ route('about')}}">Secure Payment</a></li>
                                    <li><a href="{{ route('privacy')}}">Privacy Policy</a></li>
                                    <li><a href="{{ route('tearms')}}">Terms of Use</a></li>
                                    <li><a href="{{ route('product.sidebar')}}">Archived Products</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
