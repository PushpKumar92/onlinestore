                ...
                <div class="user-dashboard">
                    <div class="nav nav-item nav-pills  me-3" id="v-pills-tab" role="tablist"
                        ...
                        <button class="nav-link" id="v-pills-address-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="false">
                            <span>
                                  <i class="fa-solid fa-location" style="color: #9A9A9A; font-size: 20px;"></i>
                            </span>
                            <span class="text">
                                Address
                            </span>
                        ...
                        <button class="nav-link" id="v-pills-review-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="false">
                           <span>
                                <i class="fa-regular fa-thumbs-up" style="color: #9A9A9A; font-size: 20px;"></i>
                            </span>
                            <span class="text">
                                Reviews
                            </span>
                        ...
                        <button class="nav-link" id="v-pills-ticket-tab" data-bs-toggle="pill"
                            ...
                            aria-selected="false">
                            <span>
                                  <i class="fa-solid fa-ticket" style="color: #9A9A9A; font-size: 20px;"></i>
                            </span>
                            <span class="text">
                                Support Ticket
                            </span>
                        ...
                        <div class="nav-link">
                            <a href="{{ route('login') }}" >
                                <span>
                                <i class="fa-solid fa-right-from-bracket" style="color: #9A9A9A; font-size: 20px;"></i>
                            </span>
                                <span class="text">
                                    Logout
                                </span>
                                        ...
                                        <div class="product-wrapper">
                                            ...
                                            <div class="product-info">
                                                ...
                                                <div class="product-description">
                                                    <a href="{{ route('product.sidebar') }}" class="product-details">Rainbow
                                                        Sequin Dress
                                                    </a>
                                            ...
                                            <div class="product-cart-btn">
                                                <a href="{{ route('card') }}"  class="product-btn">Edit Review</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
